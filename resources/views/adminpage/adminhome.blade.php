                                                            ...
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="#!"><img
                                                                                src="{{asset('template/admin/assets/images/avatar-2.jpg')}}"
                                                                                data-toggle="tooltip" title="Lary Doe"
                                                                                alt="" class="img-40"></a>
                                                                        <a href="#!"><img
                                                                                src="{{asset('template/admin/assets/images/avatar-3.jpg')}}"
                                                                ...
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        ...
                                                                        <a href="#!"><img
                                                                                ...
                                                                                alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img
                                                                                src="{{asset('template/admin/assets/images/avatar-4.jpg')}}"
                                                                                data-toggle="tooltip" title="Lary Doe"
                                                                                alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img
                                                                                src="{{asset('template/admin/assets/images/avatar-2.jpg')}}"
