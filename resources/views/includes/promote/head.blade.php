<!-- Favicon -->
<link href="{{asset('template/promote/img/favicon.ico')}} " rel="icon">
...
<link href="  {{asset('template/promote/lib/animate/animate.min.css')}} " rel="stylesheet">
<link href="  {{asset('template/promote/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">

<!-- Customized Bootstrap Stylesheet -->
<link href=" {{asset('template/promote/css/bootstrap.min.css')}} " rel="stylesheet">
...
<script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    ...
    <script src="{{asset('template/promote/lib/wow/wow.min.js')}} "></script>
